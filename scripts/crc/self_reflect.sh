...
# Self-Reflect baseline (NL correction, no UNDO token) — Llama-3.2-1B on GSM8K
# Pipeline: data construction -> training (3 epochs) -> greedy eval
# Estimated time: ~2h on single A40
#
...
# ---------------------------------------------------------------
# Step 2: Train (standard SFT, 3 epochs)
# ---------------------------------------------------------------
...
WANDB_MODE=online python -m baselines.self_reflect.train \
    ...
    --wandb_run_name self-reflect-llama3.2-1b-gsm8k
